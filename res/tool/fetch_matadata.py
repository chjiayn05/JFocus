...
POKEMON_FAMILIES = [
    ...
    # ================= 萬眾矚目：伊布家族全餐 (2階段分支進化) =================
    ("133_vaporeon", [133, 134, 134], "水", "STANDARD"),         # 伊布 -> 水伊布
    ("133_jolteon", [133, 135, 135], "電", "STANDARD"),          # 伊布 -> 雷伊布
    ("133_flareon", [133, 136, 136], "火", "STANDARD"),          # 伊布 -> 火伊布
    ("133_espeon", [133, 196, 196], "超能力", "STANDARD"),       # 伊布 -> 太陽伊布
    ("133_umbreon", [133, 197, 197], "惡", "STANDARD"),          # 伊布 -> 月亮伊布
    ("133_leafeon", [133, 470, 470], "草", "STANDARD"),          # 伊布 -> 葉伊布
    ("133_glaceon", [133, 471, 471], "冰", "STANDARD"),          # 伊布 -> 冰伊布
    ("133_sylveon", [133, 700, 700], "妖精", "STANDARD"),        # 伊布 -> 仙子伊布

    # ================= 經典人氣 2 階段寶可夢 =================
    ("058_arcanine", [58, 59, 59], "火", "STANDARD"),            # 卡蒂狗 -> 風速狗
    ("129_gyarados", [129, 130, 130], "水 / 飛行", "STANDARD"),  # 鯉魚王 -> 暴鯉龍
    ("123_scizor", [123, 212, 212], "蟲 / 鋼", "STANDARD"),      # 飛天螳螂 -> 巨鉗螳螂
    ("349_milotic", [349, 350, 350], "水", "STANDARD"),          # 笨笨魚 -> 美納斯
    ("447_lucario", [447, 448, 448], "格鬥 / 鋼", "STANDARD"),   # 利歐路 -> 路卡利歐
    ("570_zoroark", [570, 571, 571], "惡", "STANDARD"),          # 索羅亞 -> 索羅亞克
    ("769_palossand", [769, 770, 770], "幽靈 / 地面", "STANDARD"),# 沙丘娃 -> 噬沙堡爺
    ("872_frosmoth", [872, 873, 873], "冰 / 蟲", "STANDARD"),    # 雪吞蟲 -> 雪絨蛾

    # ================= 究極異獸 (大師池) =================
    ("793_nihilego", [793, 793, 793], "岩石 / 毒", "RARE"),      # 💎 虛吾伊德
    ("794_buzzwole", [794, 794, 794], "蟲 / 格鬥", "RARE"),      # 💎 爆肌蚊
    ("795_pheromosa", [795, 795, 795], "蟲 / 格鬥", "RARE"),     # 💎 費洛美螂
    ("796_xurkitree", [796, 796, 796], "電", "RARE"),            # 💎 電束木
    ("798_kartana", [798, 798, 798], "草 / 鋼", "RARE"),         # 💎 紙御劍
    ("799_guzzlord", [799, 799, 799], "惡 / 龍", "RARE"),        # 💎 惡食大王

    # ================= 帕底亞 悖謬寶可夢 (大師池) =================
    ("984_great_tusk", [984, 984, 984], "地面 / 格鬥", "RARE"),  # 💎 雄偉牙 (古代頓甲)
    ("985_scream_tail", [985, 985, 985], "妖精 / 超能力", "RARE"),# 💎 吼叫尾 (古代胖丁)
    ("987_flutter_mane", [987, 987, 987], "幽靈 / 妖精", "RARE"),# 💎 振翼髮 (古代夢妖)
    ("1005_roaring_moon", [1005, 1005, 1005], "龍 / 惡", "RARE"),# 💎 轟鳴月 (古代暴飛龍)
    ("990_iron_treads", [990, 990, 990], "地面 / 鋼", "RARE"),   # 💎 鐵轍跡 (未來頓甲)
    ("991_iron_bundle", [991, 991, 991], "冰 / 水", "RARE"),     # 💎 鐵包袱 (未來信使鳥)
    ("992_iron_hands", [992, 992, 992], "格鬥 / 電", "RARE"),    # 💎 鐵臂膀 (未來超力王)
    ("1006_iron_valiant", [1006, 1006, 1006], "妖精 / 格鬥", "RARE"),# 💎 鐵武者 (未來艾路雷朵/沙奈朵)
]
