...
public class FocusApp extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        timerLayout.getChildren().addAll(
            new Label("JFocus - 專注監控系統") {{ setStyle("-fx-text-fill: #bdc3c7; -fx-font-size: 14px;"); }},
            modeSelector,
            inputArea,
            petImageView,
            petStatusLabel,
    ...
    private void setupButtonStyles() {
        startBtn.setStyle("-fx-background-color: #27ae60; -fx-text-fill: white; -fx-font-weight: bold; -fx-padding: 10 30;");
        stopBtn.setStyle("-fx-background-color: #c0392b; -fx-text-fill: white; -fx-font-weight: bold; -fx-padding: 10 30;");
    }
